...
export const Get = (properties: { path: string, tag: string, isIndependentRoute?: boolean }, payload: Payload, middlewares: any[] = []): MethodDecorator => {
  ...
  return (target, propertyKey: string): void => {
    ...
    const apiDoc = GenerateApiDoc({ ...properties, ...{ method: "get" } }, [], payload);
    routes.push({
      requestMethod: "get",
