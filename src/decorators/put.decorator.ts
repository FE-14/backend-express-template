...
export const Put = (properties: { path: string, tag: string, isIndependentRoute?: boolean }, payload: Payload, middlewares: any[] = []): MethodDecorator => {
  ...
  return (target, propertyKey: string): void => {
    ...
    const apiDoc = GenerateApiDoc({ ...properties, ...{ method: "put" } }, [], payload);
    routes.push({
      requestMethod: "put",
